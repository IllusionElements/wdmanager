import { lazy } from "@manager/utils/lazy";
export const Dragon = {
    ...
    breedingCaveLevel: lazy(() => import("./breedingCaveLevel"), "breedingCaveLevel"),
    ...
    defaultIconFileName: lazy(() => import("./defaultIconFileName"), "defaultIconFileName"),
